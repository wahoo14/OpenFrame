...
# (list) Permissions
# (See https://python-for-android.readthedocs.io/en/latest/buildoptions/#build-options-1 for all the supported syntaxes and properties)(name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=18)
